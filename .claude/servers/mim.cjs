            ...
            inputSchema: {
              ...
              properties: {
                category: {
                  type: "string",
                  description:
                    "Category name for organizing this knowledge. Use descriptive categories like: architecture, api, database, pattern, dependency, workflow, config, gotcha, convention, testing, security, deployment, frontend, backend, auth, etc. Any relevant category name is acceptable.",
                  examples: [
                    "architecture",
                    "api",
                    "database",
                ...
                topic: {
                  type: "string",
                  description:
                    'Brief, descriptive title for what you learned (e.g., "Redis caching strategy", "JWT authentication flow", "MongoDB connection pooling")',
                },
                details: {
                  type: "string",
                  description:
                    "Complete details of what you discovered. Include specifics, configuration values, important notes, and any context that would help understand this knowledge later.",
                },
                files: {
                  type: "string",
                  description:
                    "Comma-separated list of related file paths where this knowledge was discovered (optional but recommended)",
                  examples: [
                    "app.js",
                    "src/auth/jwt.js, src/middleware/auth.js",
                    "config/database.yml",
                  ],
                },
              },
