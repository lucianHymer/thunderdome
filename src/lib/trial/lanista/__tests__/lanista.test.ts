...
import { LanistaOutputSchema } from '../../../claude/schemas.js';
  ...
  const validOutput = {
    ...
    gladiators: [
      ...
      },
      {
        ...
        persona:
          'You obsess over performance. Every millisecond matters. Profile and optimize.',
...
console.log('\nRunning Lanista integration tests...\n');
